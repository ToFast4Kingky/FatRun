...
_LerpUV_Fade_1("_LerpUV_Fade_1", Range(0, 1)) = 0.134
...
float2 LerpUV_1=i.texcoord;
LerpUV_1 = lerp(i.texcoord,_Simple_Displacement_Rotative_1,_LerpUV_Fade_1);
float4 SourceRGBA_1 = tex2D(_MainTex, LerpUV_1);
